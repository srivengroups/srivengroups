    ...
    return (
        <section id="contactUs" className="contactSection">
            ...
            <div data-aos="flip-left" data-aos-delay="150" className="form-Container aos-init aos-animate">
                <form  name="reachUs" method="POST" >
                    <input type="hidden" name="form-name" value="reachUS" />
                    ...
                    <div className="inputContainer">
                        <input type="text" name="comment" id="comment" placeholder="Write what your are looking for ?" />
                    </div>
                    <div className="inputContainer">
